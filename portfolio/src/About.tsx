function About() {
  return (
    <div className="h-auto w-[98%] justify-center text-[#3A606E] dark:text-[#ffffff] z-10">
      ...
      <br />
     <div className="border-1 border-[#f2f2f2] rounded-3xl h-50 bg-[#f5f5f567] z-10">
    <ul className="columns-2 list-none py-6 px-25 m-0 justify-between items-center font-light text-[16px]">
