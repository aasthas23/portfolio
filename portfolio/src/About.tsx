function About() {
  return (
    ...
    <ul className="columns-1 list-none py-2 px-15 sm:py-2 sm:px-15 md:py-6 md:px-25 m-0 justify-between items-center font-light sm:text-[10px] md:text-[16px] sm:columns-1 md:columns-2 text-[12px]">
      ...
      <br />
        <ul>
            <li>
                ...
                <p className="font-light text-[18px] sm:text-[15px] md:text-[20px]"> • Foundations of Cybersecurity, Play it safe: manage security risk, Connect and Protect: Networks and network
